...
$sql = ("SELECT * FROM `archive` LIMIT 8 OFFSET $StartIndex");

$page = 'SELECT * FROM archive';
                ...
                <div class="d-flex flex-wrap " style="gap: 3em;">
                    ...
                    if (count($reservation) > 0) {
                        foreach ($reservation as $book) {
                            ...
                            $date = "SELECT * FROM reservation WHERE Id_reservation = '$id_reservation'";
                            $date = $conn->query($date);
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                     In:
                                        <?php echo $date['date_de_reservation'] ?>
                                            </p>
                                        </div>
                                    </div>
                            <?php
            ...
            <nav class="mt-5 mb-5 " aria-label="Page navigation example">
                <ul class=" flex-wrap pagination justify-content-center">
                    <?php for ($i = 1; $i <= $pagesNum; $i++) { ?>
                        <li class="page-item"><a class="page-link" href="<?php echo "archive.php?pageId=" . $i ?>"><?php echo $i; ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
