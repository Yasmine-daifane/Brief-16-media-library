...
$add_loan = "INSERT INTO `l_emprunt` (`Id_l_emprunt`, `la_date_d_emprunt`, `la_date_du_retour`, `Id_adhérent`, `Id_reservation`, `Id_ouvrage`) VALUES (NULL, NOW(), '', '$id_member', '$id_reservation', '$id_book')";
